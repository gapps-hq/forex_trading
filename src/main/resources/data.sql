INSERT INTO historical_data(currency_base, currency_quote, price, lot_size, time_completed) VALUES('USD', 'EUR', 1.3031, 400, parsedatetime('2017-07-10 23:04:59.004', 'yyyy-MM-dd hh:mm:ss.SS'));
INSERT INTO historical_data(currency_base, currency_quote, price, lot_size, time_completed) VALUES('USD', 'EUR', 1.3028, 3000, parsedatetime('2017-07-09 23:04:59.004', 'yyyy-MM-dd hh:mm:ss.SS'));
INSERT INTO historical_data(currency_base, currency_quote, price, lot_size, time_completed) VALUES('JPY', 'USD', 1.1351, 15500, parsedatetime('2017-07-08 23:04:59.004', 'yyyy-MM-dd hh:mm:ss.SS'));
